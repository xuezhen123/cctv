	...
	<form id="functionForm" method="post" action="functionAction_add.action">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>是否生成菜单</td>
						<td>
							<select editable="false" name="generatemenu" class="easyui-combobox">
					...
					<tr>
						<td>父权限</td>
						<td>
							<input editable="false" name="parentFunction.id" 
								class="easyui-combotree" data-options="url:'functionAction_listajax.action'"/>
						</td>
					</tr>
					<tr>
						<td>描述</td>
