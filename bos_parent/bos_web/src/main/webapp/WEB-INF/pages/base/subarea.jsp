...
<script type="text/javascript">
	...
	function doExport(){
		...
		//$.post("subareaAction_exportSubarea.action");
	}
			...
			<form id="addSubareaForm" method="post"
				...
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							data-options="required:true,valueField:'id',mode:'remote',
    										textField:'name',url:'regionAction_listajax.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
					...
					<tr>
						<td>单双号</td>
						<td>
							<select editable="false" class="easyui-combobox" name="single" style="width:150px;">  
