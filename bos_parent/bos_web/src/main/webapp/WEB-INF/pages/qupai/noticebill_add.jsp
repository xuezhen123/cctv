		...
		<form id="noticebillForm" action="noticebillAction_add.action" method="post">
			...
			<table class="table-edit" width="100%" align="center">
				...
				<tr>
							...
							$(function(){
								...
								$("input[name=telephone]").blur(function(){
									...
									if(telephone != null && telephone != ''){
										//发送ajax请求，请求Action，在Action中调用crm代理对象，远程访问crm服务根据手机号查询客户信息
					...
					<td>客户编号:</td>
					<td>
						<input type="text" class="easyui-validatebox" name="customerId" />
					</td>
				</tr>
				<tr>
					<td>客户姓名:</td>
					<td>
						<input type="text" class="easyui-validatebox" name="customerName" />
					</td>
					<td>联系人:</td>
					<td>
						<input type="text" class="easyui-validatebox" name="delegater" />
					</td>
				</tr>
				<tr class="title">
				...
				<tr>
					<td>品名:</td>
					<td>
						<input type="text" class="easyui-validatebox" name="product" />
					</td>
					<td>件数:</td>
				...
				<tr>
					<td>重量:</td>
					<td>
						<input type="text" class="easyui-numberbox" name="weight" />
					</td>
					<td>体积:</td>
					<td>
						<input type="text" class="easyui-validatebox" name="volume" />
					</td>
				</tr>
				<tr>
					<td>取件地址</td>
					<td colspan="3">
						<input type="text" class="easyui-validatebox"
							name="pickaddress" required="true" size="111" />
					</td>
				</tr>
				<tr>
					<td>到达城市:</td>
					...
					<td>预约取件时间:</td>
					<td>
						<input type="text" class="easyui-datebox" name="pickdate"
				...
				<tr>
					<td>备注:</td>
					<td colspan="3">
						<textarea rows="5" cols="80" type="text"
							class="easyui-validatebox" name="remark"></textarea>
					</td>
				</tr>
			</table>
		</form>
